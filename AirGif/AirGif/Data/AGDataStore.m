...
- (NSManagedObjectModel *)managedObjectModel
{
  ...
  NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"AirGifs" withExtension:@"momd"];
...
+ (AGDataStore*)sharedStore {
  static AGDataStore *_dataStore;
  static dispatch_once_t onceToken = 0;
  dispatch_once(&onceToken, ^{
    _dataStore = [[self alloc] init];
  });
  return _dataStore;
}
